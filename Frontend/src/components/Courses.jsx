...
const Courses = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-2">
      {courses.length > 0 ? (
        courses.map(course => (
          <div onClick={()=>{navigate('/dashboard/course-detail/'+course._id)}} key={course.id} className="bg-gray-200 rounded-2xl  py-1 px-2 border-2 border-dashed border-indigo-400 hover:shadow-xl hover:shadow-black duration-200">
